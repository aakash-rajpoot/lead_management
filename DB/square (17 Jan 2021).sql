...
INSERT INTO `sq_members` (`id`, `name`, `email`, `phone`, `alt_phone`, `gender`, `dob`, `pass`, `joining_date`, `resignation_date`, `aadhar`, `pan`, `permanent`, `correspondence`, `profile_image`, `auth_token`, `status`) VALUES
...
(21, 'dgfvhbdfnv', 'aakash143only4u@gmail.com', 8859423143, 0, '', '2020-12-02', '', '2020-12-23', '2020-12-27', 'Aakash_Shishodia_resume4.pdf', 'Aakash_Shishodia_resume3.pdf', 'Village-Sapnawat ,Block- Dhaulana, District - Hapur, State - UP', 'Sector -34, Noida, UP', '', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjIxIiwiZW1haWwiOiJhYWthc2gxNDNvbmx5NHVAZ21haWwuY29tIiwiaWF0IjoxNjEwMTEyNjE0LCJleHAiOjE2MTAxMzA2MTR9.kbZRcmPCs-aaGrESOd0KcTggiRr5pLbj7IPOUo9vhy4', 1),

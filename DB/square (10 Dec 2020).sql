...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2020 at 06:24 AM
...
INSERT INTO `sq_lead` (`id`, `name`, `email`, `phone`, `alt_phone`, `property_address`, `client_address`, `role`, `remark`, `other_info`, `reference`, `date`, `status`) VALUES

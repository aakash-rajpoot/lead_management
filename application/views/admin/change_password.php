                    ...
                    <div class="rounded-sm">
                        <div class="text-box">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
									    <label class="label-input" for="old_pass">Old Password <span class="text-danger font-weight-medium">*</span></label>
				                 	    <input class="form-control form-control-lg"  type="password" name="old_pass" id="old_pass"><br />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
									    <label  class="label-input" for="new_pass">New Password <span class="text-danger font-weight-medium">*</span></label>
				                  	    <input class="form-control form-control-lg"  type="password" name="new_pass" id="new_pass"><br/>
                                    </div>
                            ...
                            <div class="d-flex justify-content-center">
								<input type="submit" name="admin_change_password" value="Change Password" class="btn btn-primary" />
                            </div>
							<?=form_close(); ?>
                        </div>
                    </div>
